...
public class MauriceLazerStaffItem extends Item {
	public MauriceLazerStaffItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MauriceLazerStaffEntity entityarrow = MauriceLazerStaffEntity.shoot(world, entity, world.getRandom(), 100f, 0, 0);
